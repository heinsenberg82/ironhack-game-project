...
export default class Hero extends Character{
    constructor(ctx) {
        ...
        const actions = [
            ...
            new Action("slash2", 5, 10, 9, true,"a", false,  null, { path: "../sounds/hero/light-attack.mp3", frame: 0 }),
            new Action("slash1", 7, 10, 8, true,"s", false, null, { path: "../sounds/hero/medium-attack.mp3", frame: 0 }),
            new Action("slam", 5, 15, 10, true,"d", false, null, { path: "../sounds/hero/strong-attack.mp3", frame: 0 }),
            new Action("spin", 6, 16, 11, true,"f", false, null, { path: "../sounds/hero/spin-attack.mp3", frame: 0 }),
